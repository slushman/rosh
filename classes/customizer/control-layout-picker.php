	 ...
	 */
	 public function render_content() {
		 ...
		 ?><label>
			 ...
			 <ul>
				 <li>
					 	<img src="<?php echo trailingslashit( get_template_directory_uri() ); ?>1col.png" alt="Full Width" />
						<input type="radio" name="<?php echo $this->id; ?>" id="<?php echo $this->id; ?>[full_width]" value="1" />
				</li>
				 <li>
					 <img src="<?php echo trailingslashit( get_template_directory_uri() ); ?>2cl.png" alt="Left Sidebar" />
					 <input type="radio" name="<?php echo $this->id; ?>" id="<?php echo $this->id; ?>[left_sidebar]" value="1" />
				 </li>
				 <li>
					 <img src="<?php echo trailingslashit( get_template_directory_uri() ); ?>2cr.png" alt="Right Sidebar" />
