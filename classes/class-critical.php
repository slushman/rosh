...
class Rosh_Critical {
	...
	public function print_header_scripts() {
		...
		include trailingslashit( get_template_directory() ) . 'assets/js/loadcss.min.js';
	...
	public function print_critical() {
		...
		?><style type="text/css"><?php
			...
			include trailingslashit( get_template_directory() ) . 'critical.css';

			//include trailingslashit( get_template_directory() ) . 'critical/critical/' . $template . '.min.css';
