...
class Rosh_Updater {
	...
	/**
	 * Returns whether the config has been set for this instance.
	 *
	 * @return 		bool 			TRUE if the config is present, otherwise FALSE.
	 */
	 ...
	 * Set defaults.
	 *
	 * @link 	https://help.github.com/articles/downloading-files-from-the-command-line
	 * @since 1.2
	 */
