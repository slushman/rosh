...
class Rosh_Metabox_Demo {
	...
	/**
	 * Array of conditions when and where the metabox should appear.
	 *
	 * @since 		1.0.0
	 * @var 		array
	 */
	...
	public function __construct( $theme_name, $version ) {
		...
		$this->nonce 		= 'nonce_rosh_demo';

		$this->conditions['post_type'] 	= 'page';
		$this->conditions['cap'] 		= 'edit_post';

		$this->fields[] 	= array( 'field-checkbox', 'checkbox', '' );
		$this->fields[] 	= array( 'field-color', 'color', '' );
		$this->fields[] 	= array( 'field-date', 'date', '' );
		$this->fields[] 	= array( 'field-editor', 'editor', '' );
		$this->fields[] 	= array( 'field-file', 'url', '' );
		$this->fields[] 	= array( 'field-image', 'hidden', '' );
		$this->fields[] 	= array( 'field-menu', 'select', '' );
		$this->fields[] 	= array( 'field-page', 'select', '' );
		$this->fields[] 	= array( 'field-taxonomy', 'select', '' );
		$this->fields[] 	= array( 'field-radios', 'radio', '' );
		$this->fields[] 	= array( 'field-select', 'select', '' );
		$this->fields[] 	= array( 'field-text', 'text', '' );
		$this->fields[] 	= array( 'field-textarea', 'textarea', '' );
		$this->fields[] 	= array( 'field-time', 'time', '' );
	...
	public function add_metaboxes( $post_type, $post_obj ) {
		...
		add_meta_box(
			'demo',
			apply_filters( $this->theme_name . '-demo-title', esc_html__( 'Demo', 'rosh' ) ),
			array( $this, 'metabox' ),
			$post_type,
			'normal',
			'default',
