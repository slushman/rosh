...
function rosh_categorized_blog() {
	...
	if ( false === ( $all_the_cool_cats = get_transient( 'rosh_categories' ) ) ) {
		...
		set_transient( 'rosh_categories', $all_the_cool_cats );

	}

	if ( $all_the_cool_cats > 1 ) {

		// This blog has more than 1 category so rosh_categorized_blog should return true.
		return true;

	} else {

		// This blog has only 1 category so rosh_categorized_blog should return false.
		return false;
